...
' wave limits in nm
Global Const hp816x_PWM_WAVE_MIN =  300.0E-9#
Global Const hp816x_PWM_WAVE_MAX =  1800.0E-9#
' averaging time limits in s
Global Const hp816x_PWM_ATIME_MIN =  25.0E-6#
Global Const hp816x_PWM_ATIME_MAX =  900.0#
' correction limits in dbm
Global Const hp816x_PWM_CORR_MIN =   -180.0#
Global Const hp816x_PWM_CORR_MAX =   200.0#
' reference limits in db, dBm
Global Const hp816x_PWM_REV_DB_MIN =   -180.0#
Global Const hp816x_PWM_REV_DB_MAX =   200.0#
Global Const hp816x_PWM_REV_WATT_MIN =   1.0e-18#
Global Const hp816x_PWM_REV_WATT_MAX =    1.0e18#
' power range in dBm
Global Const hp816x_PWM_RANGE_MIN =  -110.0#
Global Const hp816x_PWM_RANGE_MAX =  30.0#
' power range mode
...
Global Const hp816x_LOGSTAB_TTIME =   3600.0 * 24.0#
Global Const hp816x_LOGSTAB_DTIME =   3600.0 * 24.0#
' function types
...
' attenuation limits 
Global Const hp816x_ATT_MIN =  0.0#
Global Const hp816x_ATT_MAX = 10.0#
'  Modulation enabled 
...
Global Const hp816x_RLM_ATIME_MIN =  20.0E-3#
Global Const hp816x_RLM_ATIME_MAX =  10.0#
' attenuation limits
Global Const hp816x_RLM_ATT_MIN =   0.0#
Global Const hp816x_RLM_ATT_MAX =   3.0#
        ' *************************************************
...
' sweep limits 
Global Const hp816x_MIN_SWEEP_STEP =    0.1e-12#
Global Const hp816x_MIN_SWEEP_CYCLE  =  1
Global Const hp816x_MAX_SWEEP_CYCLE  =  999
Global Const hp816x_MIN_SWEEP_DWELL =   100.0e-3#
Global Const hp816x_MAX_SWEEP_DWELL =   1.0e6#
' sweep speeds 
Global Const hp816x_SWEEP_SPEED_LOW =      0.5e-9# 
Global Const hp816x_SWEEP_SPEED_MEDIUM =   5.0e-9# 
Global Const hp816x_SWEEP_SPEED_HIGH =    40.0e-9# 
' rise time limits 
Global Const hp816x_MIN_RISETIME =      0.0#
Global Const hp816x_MAX_RISETIME =      3.0#
' coherence control level range for DFB laser sources
Global Const hp816x_CCMIN_LEVEL =      1.0#
Global Const hp816x_CCMAX_LEVEL =      99.98#
' SBS level range for Fireball laser sources
Global Const hp816x_SBSMIN_LEVEL =      0.0#
Global Const hp816x_SBSMAX_LEVEL =      100.0#
'  Modulation types 
